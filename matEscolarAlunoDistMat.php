...
<html lang="en">
  <head>
    ...
    <title>Material Escolar FATAD</title>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <tr>
                            <td><h5 style="color: blue;">Distribuir Material Aluno
                    ...
                    $sql = "SELECT a.idAluno,a.cpfAluno,a.nomeAluno, h.* ,d.codigoDisciplina,d.nomeDisciplina, m.*, 
                            (SELECT dtPagamento 
                                FROM fatadgestao.tb_op_financeira 
                                WHERE idMaterial = h.idDisciplina 
                                AND idResp = a.cpfAluno 
                                AND perfil = 'FATAD' 
                                LIMIT 1 ) AS dtPagamento
                        ...
                        JOIN tb_matricula AS m ON a.idAluno = m.idAluno
                    WHERE 
                        h.idNucleo = 1 
                ...
                <div class="mb-3">
                    <label>O material está pago?&nbsp;&nbsp;&nbsp;</label>
                    <label>
                        <input type="radio" name="pagamento" value="sim" required onclick="toggleCampos(true)"> Sim&nbsp;&nbsp;
                    </label>
                    <label>
                        <input type="radio" name="pagamento" value="nao" required onclick="toggleCampos(false)"> Não
                    </label>
                </div>
