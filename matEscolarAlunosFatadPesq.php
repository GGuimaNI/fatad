            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h5 style="color: blue;">Pesquisar Alunos FATAD
                        <a href="matEscolarAlunosFatad.php" class="btn btn-danger float-end">Voltar</a>
                        </h4>
                    </div>
                    <div class="card-body">
                        
                        <form action="matEscolarAlunosFatad.php" method="POST">
                            <div class="mb-3">
