...
?>
    ...
    <body>
        ...
        <form class="importar_arquivos" action="importar_arquivos.php" method="post" enctype="multipart/form-data">
        <h4 style="color: blue;" ><center>Selecionar Pasta e Importar Arquivos</center></h4>
                    ...
                    <div class="panel-body">
                        <div class="form-group">                                               
                            <select   required="" name="idDisciplina" id="idDisciplina" class="form-control">
                                ...
                                <?php $rsCursos = $fg->findDisciplinas($idDisciplina=1);
                                foreach ($rsCursos as $row) {
                                    ?>
                                    <option value="<?= $row->idDisciplina ?>"><?= $row->nomeDisciplina ?></option>                                                        
                                <?php 
                                } ?>
                            </select>
                        </div>
