        ...
        <div class="col-md-12">
          <div class="card">
            ...
            <div class="card-header">
              <br>
              <h5 style="color: blue;">Matricular Aluno </h5>
            </div>
            ...
            <div class="card-body">
                <form action="matricularGRUDacoes.php" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="valorMaterial" class="form-control" placeholder="Ex: 99,90" required title="Informe o valor do material.">                    </div>
                    <div class="mb-3">
