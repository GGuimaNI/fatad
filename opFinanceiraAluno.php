            ...
            <div class="card-body">
              <table class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  }elseif($privilegio=="opFatad" OR $privilegio=="admFatad"){
                    $sql = "SELECT * FROM qry_opfinanceirogestaonucleo "
                    . "WHERE ".$argumento;
                  }
...
//                        $dtPagOk=date('d/m/Y', strtotime($disciplina['dtPagamento']));
                            ...
                            if (is_null($nucleo['dtPagamento'])
                               OR $nucleo['dtPagamento']=='0000-00-00'
                               OR $nucleo['dtPagamento']=='' ){  
...
//                            if($disciplina['idOp']>0){
                            if (is_null($aluno['dtPagamento'])
                               OR $aluno['dtPagamento']=='0000-00-00'
                               OR $aluno['dtPagamento']=='' ){                                 
                            ?>
                             <a href="opFinanGestaoReceber.php?
                             id=<?=$aluno['idResp']?>
                             &perfil=<?=$aluno['perfil']?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="meuModalLabel">Aviso de Débito</h5>
