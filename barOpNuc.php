...
<nav class="menu-lateral">
    <ul class="menu">
        ...
        <li>
            <a href="#">Administração</a> <!-- Link para services.php -->
            <ul>
                <li><a href="al_troca_senha.php">Trocar Senha</a></li> <!-- Link para web-design.php -->
                <li><a href="opFinanceiraGestao.php">Mov Financeiro</a></li> <!-- Link para web-design.php -->
            </ul>
        </li>
        <li>
            <a href="#">Material Escolar</a> <!-- Link para services.php -->
            <ul>
                <li><a href="matEscolarNucleos.php">Material Núcleo</a></li> <!-- Link para marketing.php -->
            </ul>
        </li>
        <li>
            <a href="#">Alunos</a> <!-- Link para services.php -->
            <ul>
                <li><a href="alunosGRUD.php">Listar</a></li> <!-- Link para web-design.php -->
                <li><a href="alunosGRUDcreate.php">Cadastrar</a></li> <!-- Link para web-design.php -->
                <li><a href="matricularGRUD.php">Matricular</a></li> <!-- Link para seo.php -->
                <li><a href="pesquisarAlunoCurso.php">Acompanhar Desempenho</a></li> <!-- Link para marketing.php -->
            </ul>
        </li>
        <li>
            <a href="#">Cursos</a> <!-- Link para services.php -->
            <ul>
                <li><a href="criarTurmasGRUD.php">Turmas</a></li> <!-- Link para marketing.php -->
            </ul>
        </li>
