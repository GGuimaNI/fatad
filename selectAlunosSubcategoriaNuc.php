...
$categoria = $_GET['idNucleo'];
$selected = isset($_GET['selected']) ? $_GET['selected'] : null;

$query = $conn->prepare("SELECT distinct ha.idAluno, ha.idCurso,ha.idTurma, idNucleo, "
            ...
            ."WHERE idNucleo=:categoria_id "
            ."ORDER BY idTurma, nomeAluno");
...
?>
    <option value="<?php echo $option['idAluno']?>" <?php echo $check; ?>><?php echo $option['nomeAluno']." - ".$option['nomeCurso']?></option>
<?php
}
