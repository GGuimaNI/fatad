...
$nomeDocumento=$_GET['nomeArq'];
$idDocumento= filter_input(INPUT_GET, 'idDowndocs', FILTER_SANITIZE_NUMBER_INT);
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="./importar_arquivos_listar.php" class="btn btn-danger btn-sm float-end">Voltar</a>
                        </h5>
                    </div>
                    <div class="card-body">
                        
                        <form action="importar_arquivos_acoes.php" method="POST">
