...
<html lang="en">
  ...
  <body>
    <?php include('nucleosGRUDnavbar.php'); ?>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Pesquisar
                        <a href="nucleosGRUDlistDoc.php" class="btn btn-danger float-end">Voltar</a>
                        </h4>
                    </div>
                    <div class="card-body">
                        
                        <form action="nucleosGRUDlistDoc.php" method="POST">
                            <div class="mb-3">
                            ...
                            <input type="hidden" id="idAluno" name="idAluno" value="<?=$idNucleo?>">
                            </div>
