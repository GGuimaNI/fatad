...
$password = '1634';  // Senha do MySQL (ou deixe em branco se não houver senha)
$database = 'fatadgestao';  // Nome do banco de dados

// Caminho para salvar o backup
$backup_file = 'C:\backupFatad\backupFatad' . $database . '_' . date("Y-m-d_H-i-s") . '.sql';

// Caminho completo para o mysqldump (ajustar conforme seu ambiente)
$mysqldumpPath = '"C:\wamp64\bin\mysql\mysql8.3.0\bin\mysqldump.exe"';  // Altere conforme seu ambiente
