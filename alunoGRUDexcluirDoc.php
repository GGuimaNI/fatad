            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Excluir
                        <a href="alunoGRUDlistDoc.php?idAluno=<?=$idAluno?>" class="btn btn-danger float-end">Voltar</a>
                        </h4>
                    </div>
                    <div class="card-body">
                        ...
                        <form action="alunosGRUDacoes.php" method="POST">
                            ...
                            <div class="mb-3">
                              <button type="submit" name="excluir_documento" class="btn btn-primary">Excluir</button>
                            </div>
                        </form>
                    </div>
                </div>
